...
// concatinating using the old way
// const url = PATH_BASE + PATH_SEARCH + '?' + PARAM_SEARCH + DEFAULT_QUERY;

// Concatinating using ES6 syntax
...
class Javascript extends Component {
  ...
  // Set top stories methods
  setTopStories(result){
    // Get the hits page any page from result
    const { hits, page } = result;

    this.setState(updateTopStories(hits, page));
  }

  // fetch top stories methos
        ...
        <Grid>
          <Row>
            ...
            <div className="text-center alert">
                ...
                <ButtonWithLoading
                  isLoading = {isLoading}
                  className = "loadmore-btn btn btn-success"
                  onClick = { () => this.fetchTopStories(searchTerm, page + 1) }
                >Load more</ButtonWithLoading>
